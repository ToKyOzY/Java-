...
public class HA160 extends FMercedes{
   ...
   public static void main(String[] args) {
      ...
      //EToyota arb3=new EToyota();
       ...
       //Abstract class'lar constructor barindirir ama obje uretmezler
       //Toyota class'i abstract class oldugundan obje uretilmez..

       /*
       List<String> list1=new List<String>();
       List<String > list2=new ArrayList<>();

       Abstract bir class'in ozelliklerini tasiyan bir obje olusturmak
       istedigimizde Data turunu istedigimiz
       abstract class constructor'i ise child'i olan concrete bir class'dan seceriz
        */
   }
}
